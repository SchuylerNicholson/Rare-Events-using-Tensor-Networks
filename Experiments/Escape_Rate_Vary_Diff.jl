...
# Calculate the rate of going from A to B varying the diffusion constant, used in PRX 2023
# Essentially the same as Proj_EscapeProbThree.jl
# Parameters
L = 4 # Number of sites
a = 1.06; b= .68;
